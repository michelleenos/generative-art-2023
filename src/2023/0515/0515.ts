...
new p5(
    (p: p5) => {
        ...
        p.setup = function () {
            ...
            folder.addBinding(PS, 'precision', { min: 3, max: 180, step: 1 })
            folder.addBinding(PS, 'step', { min: 10, max: 300, step: 1 })
            folder.addBinding(PS, 'diff', { min: 0, max: 1, step: 0.1 })
            folder.addBinding(PS, 'noiseScaleDenom', { min: 0, max: 10, step: 0.1 })
            folder.addBinding(PS, 'noiseAmt', { min: 0, max: 2, step: 0.01 })
            folder.addBinding(PS, 'radiusToStep', { min: 0.01, max: 0.5, step: 0.01 })
